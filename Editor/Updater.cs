...
public class Updater : Editor
{
    ...
    private const string PackageName = "com.popcron.input";
    private const string PackageURL = "https://raw.githubusercontent.com/popcron/input/master/package.json";
    private const string CanUpdateKey = "Popcron.Input.CanUpdate";
    private const string CheckForUpdateText = "Popcron/Input/Check for updates";
    private const string UpdateText = "Popcron/Input/Update";
